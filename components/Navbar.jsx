                ...
                {providers &&
                  Object.values(providers).map((provider) => (
                    <button
                      ...
                      key={provider.id}
                      className="cursor-pointer flex items-center text-white bg-gray-700 hover:bg-gray-900 hover:text-white rounded-md px-3 py-2"
                    >
                      <FaGoogle className="text-inherit mr-2" />
